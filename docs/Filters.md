...
---
Filters allow you to modify [[variables]] in [[Obsidian Web Clipper/Templates|Hexel Capture templates]]. Filters are applied to variables using the syntax `{{variable|filter}}`.
